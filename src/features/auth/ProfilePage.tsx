...
import { isProUser, canUseCloudAi, canUseEmailReminders, canUseVaultBackup } from '@/lib/planLimits';
    ...
    <div className="min-h-full pb-28">
      ...
      <main className="page-main animate-fade-up space-y-5">
        ...
        <section className="space-y-2">
          ...
          <div className="flex gap-2">
            <SettingsNavPill to="/profile/feedback">Feedback</SettingsNavPill>
          </div>
        </section>
        ...
        <section className="space-y-2">
          ...
          <div className="flex gap-2">
            ...
            <SettingsNavPill to={backupAllowed ? '/profile/backup' : '/profile/plan'}>
              {backupAllowed ? 'Backup' : 'Backup · Pro'}
            </SettingsNavPill>
          </div>
        </section>
